...
function LoginPage() {
  ...
  const google = async () => {
    ...
    try {
      ...
      // result.redirected → browser will redirect
    } catch (e: any) {
        ...
        <div className="relative space-y-8 max-w-md">
          <div>
            ...
            <p className="mt-4 text-white/70 leading-relaxed">
              Real-time stock, intelligent alerts, and clean movement history —
          ...
          <div className="grid grid-cols-1 gap-3">
            {[
              ...
              <div
                key={f.label}
                className="flex items-start gap-3 rounded-xl border border-white/10 bg-white/5 backdrop-blur px-4 py-3"
              >
...
function GoogleIcon() {
  return (
    <svg className="h-4 w-4" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="#EA4335"
        d="M12 10.2v3.9h5.5c-.24 1.4-1.66 4.1-5.5 4.1-3.3 0-6-2.74-6-6.1s2.7-6.1 6-6.1c1.88 0 3.14.8 3.86 1.48l2.64-2.54C16.8 3.3 14.62 2.3 12 2.3c-5.46 0-9.9 4.44-9.9 9.9s4.44 9.9 9.9 9.9c5.72 0 9.5-4.02 9.5-9.68 0-.65-.07-1.15-.16-1.62H12z"
      />
      <path
        fill="#4285F4"
        d="M21.34 12.42c0-.65-.07-1.15-.16-1.62H12v3.9h5.5c-.11.66-.7 1.66-2 2.36l3.2 2.48c1.86-1.72 2.94-4.26 2.94-7.12z"
      />
      <path
        fill="#FBBC05"
        d="M5.5 14.2a6.07 6.07 0 0 1 0-4.4l-3.32-2.56A9.9 9.9 0 0 0 2.1 12.2c0 1.62.38 3.14 1.08 4.56l3.32-2.56z"
      />
      <path
        fill="#34A853"
        d="M12 22.1c2.62 0 4.82-.86 6.42-2.34l-3.2-2.48c-.86.6-2.02 1.02-3.22 1.02-2.48 0-4.58-1.66-5.34-3.9L3.34 16.96A9.9 9.9 0 0 0 12 22.1z"
      />
    </svg>
  );
}
